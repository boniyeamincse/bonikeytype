        ...
        <div className="flex-grow flex items-center justify-center py-20 animate-in fade-in zoom-in-95 duration-700">
            <div className="premium-card w-full max-w-md p-10 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                    <h2 className="text-4xl font-black mb-2 text-center uppercase tracking-tighter gradient-text">register</h2>
                    <p className="text-center text-xs font-bold uppercase tracking-[0.3em] opacity-30 mb-10">create your account</p>
                    ...
                    <p className="mt-10 text-center text-xs font-bold uppercase tracking-widest opacity-40">
                        already have an account? <a href="/login" className="text-main hover:underline decoration-2 underline-offset-4" style={{ color: 'var(--main-color)' }}>login</a>
                    </p>
                </div>
            </div>
        </div>
